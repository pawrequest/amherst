    ...
    if isinstance(v, str):
        try:
            ...
            try:
                ...
                raise ValueError(f'Invalid date string: "{v}" - expecting amherst format dd/mm/yyyy or mm/dd/yyyy')
    return v
...
MODEL_JSON3 = Annotated[dict, PlainSerializer(model_with_sub_json)]
